...
class Post {
  ...
  /*
   ...
   this builds a tree indirectly and allows for more flexibility and easier
   scalability and traversal than a messy forest tree
   */
private:
  struct Comment {
  public:
...
public:
  ...
  void addComment(const string &commenter, const string &text,
